...
var coll = new Audio("audio/abeYrr.mp3");
...
function movedice() {
     ...
     let purl = "url('ludoImg/" + x.toString() + ".png')";
...
function winnner() {
     if (turn[0][1].state == 66 && turn[0][2].state == 66 && turn[0][3].state == 66 && turn[0][4].state == 66) {
          www.play();
          wnct++;
          turn[0][1].name + " comes at " + wnct + "rd place.";
          t++;
          if (t == 4)
               t = 0;
     }
          ...
          www.play();
          wnct++;
          turn[1][1].name + " comes at " + wnct + "rd place.";
          t++;
          if (t == 4)
               t = 0;
     }
          ...
          www.play();
          wnct++;
          turn[2][1].name + " comes at " + wnct + "rd place.";
          t++;
          if (t == 4)
               t = 0;
     }
          ...
          www.play();
          wnct++;
          turn[3][1].name + " comes at " + wnct + "th place.";
          t++;
          if (t == 4)
               t = 0;
     }
